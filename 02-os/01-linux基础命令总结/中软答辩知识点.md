...
(3) shell 脚本里的 特殊字符 $(( ))、$( )、``与${ }的区别

 https://www.cnblogs.com/chenpython123/p/11052276.html 

(4) shell解析xml文件，Yaml文件

(5) server命令与 /etc/init.d及systemctl关系
...
(8) 华为hacs（high availability cluster server） 双机  https://support.huawei.com/enterprise/zh/doc/DOC1000151560 
